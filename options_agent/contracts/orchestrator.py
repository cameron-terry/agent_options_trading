...
class ShortCircuitReason(StrEnum):
    ...
    # WP-8.2: state-integrity short-circuits (WP-8.7 / WP-8.8 / WP-8.6)
    WORKING_CANCEL_FAILED = "WORKING_CANCEL_FAILED"
    ORPHAN_UNRESOLVED = "ORPHAN_UNRESOLVED"
    STATE_INTEGRITY = "STATE_INTEGRITY"
    ASSIGNMENT_HALT = "ASSIGNMENT_HALT"
